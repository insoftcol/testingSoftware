...
- **Formato del número de cuenta:** validar que sea numérico, longitud exacta de 10 dígitos, etc. Se decidió no incluir porque el banco maneja formatos variables por entidad; esta validación pertenece a la capa de infraestructura/adaptadores.
